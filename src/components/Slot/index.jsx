    ...
    return (
        <Container>
            <div className='slot-one slot'>
                <img src='https://accumed.com.br/wp-content/uploads/2023/11/ICON_MAE_1.svg' alt='logo-de-um-coração' />
            ...
            <div className='slot-two slot'>
                <img src='https://accumed.com.br/wp-content/uploads/2023/11/ICON_SEGURANCA_1.svg' alt='logo-de-um-escudo' />
            ...
            <div className='slot-three slot'>
                <img src='https://accumed.com.br/wp-content/uploads/2023/11/ICON_CUIDADO_1.svg' alt='logo-de-uma-estrela' />
            ...
            <div className='slot-four slot'>
                <img src='https://accumed.com.br/wp-content/uploads/2023/11/ICON_PREMIO_1.svg' alt='logo-de-um-trofeu' />
